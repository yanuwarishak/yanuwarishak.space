...
export default function About() {
  return (
    <MainLayout title="About – Yanuwar Ishak" LeftContent={leftContent} RightContent={rightContent}>
      ...
      <div className="w-full flex flex-col-reverse xs:flex-row justify-between md:items-start gap-6">
        <div className="w-full h-full md:w-2/5 flex flex-col justify-start">
          ...
          <div className="mt-2 flex flex-row flex-wrap gap-x-2 text-gray-500">
            ...
            <TableOfContents href="philosophy" text="Scio me nihil scire" style="italic" />
            /
      ...
      <div className="prose max-w-none text-gray-300" style={{ marginTop: '-24px' }}>
        <h2 id="me">Me</h2>
        <p>
          Hi, Yanuwar Ishak here. I'm a software engineer based in Indonesia, mainly focused on Web
          Development, especially front-end development. I graduated from college in late 2019 with
          a Bachelor of Engineering degree, majoring in Software Engineering. I have included more
        ...
        <p>
          Through my college years, I have handled several projects which put me in several roles
          such as Android developer, UI/UX Designer,{' '}
          ...
          and Web Developer. I have listed my tech knowledge that I have worked with and that I'm
          currently learning in <Link href="/tech">tech page.</Link>
        </p>
        ...
        <p>
          ...
          <i>"I know that I know nothing"</i>. I believe that learning is a lifelong process and
          it's especially true as a Software Engineer. The development of technology moves fast,
          things that might relevant 2 or 3 years ago might not be as relevant as it is today. To
          have the willingness to keep learning in order to adapt to better technology is a valuable
          asset that one can have.
        </p>
        <h2 id="personal-life">Personal life</h2>
        <p>
          Like most people, I also have hobbies. I play sports when I have the chance, and I also
          like spending time playing games, watching videos, learning new things, and mostly
          listening to music. I have put my monthly top tracks down below.
        </p>
      </div>
      {/* Spotify Section */}
      <div className="flex flex-col gap-1">
        ...
        <div className="prose max-w-none text-gray-300">
          ...
          <p>
            This site was developed to document my personal journey. Most of what's written here
            might be or might not be something of use for you. I would be grateful if you happen to
            find something that helped you. If you want to read more about this site such as
            technology used, you can visit{' '}
            <Link href="/project/personal-website">about this site</Link>, all in all thank you for
            the visit, see you.
          </p>
        </div>
      </div>
